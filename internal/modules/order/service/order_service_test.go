...
func TestOrderService_GetByID_Success(t *testing.T) {
	...
	cfg := &config.Config{}
	svc := NewOrderService(mockRepo, cfg, nil, nil, nil, mockUserSvc)
...
func TestOrderService_CreateOrder_Success(t *testing.T) {
	...
	cfg := &config.Config{}
	svc := NewOrderService(mockRepo, cfg, mockPub, mockElastic, nil, mockUserSvc)
...
func TestOrderService_UpdateStatus_Success(t *testing.T) {
	...
	cfg := &config.Config{}
	svc := NewOrderService(mockRepo, cfg, mockPub, nil, nil, nil)
...
func TestOrderService_GetAll_ErrorPropagation(t *testing.T) {
	...
	cfg := &config.Config{}
	svc := NewOrderService(mockRepo, cfg, nil, nil, nil, nil)
